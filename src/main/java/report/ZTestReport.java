...
//
//	//生成 report.html 报告路径
//	private String path = System.getProperty("user.dir") + File.separator + "target-reports" + File.separator + "report.html";
//// template 文件路径
//	private String templatePath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator + "framework" + File.separator + "ui" + File.separator + "report" + File.separator + "template";
//@Value("${report.path}")
	private String reportDir = "src/test/java/report";
	private String path = reportDir + File.separator + "report.html";
